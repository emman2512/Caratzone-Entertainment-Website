...
?>
      ...
      <?php
        $sql = "SELECT * FROM shop where category = 'album' and id='". $_GET['id']."';";  
      ...
      <div class="col-md-4">
          ...
          <h3 style="font-size:200%;">Album: <span style="color:#92a8d1""><?php echo $row['name'];?></span></h3>
    ...
    <button data-toggle="collapse" id="collapser" data-target="#descriptions" style="margin-top:2%;padding:10px;border-radius:5px;width:30%;"><span id="viewbuttontext">View</span> <img id ="viewbuttonimage" src="resources/shoppage/viewIcon.png" style="width:30%;"></button>
      ...
      <div class="col-md-4">
      <h2 style="text-align:center;margin-top:1%">More albums<img src="resources/profilepage/music.png" style="width:10%;"></h2>
     
      <div class="container-fluid">
    <div class="row" style="text-align: center;">
    <!--Album start-->
    <?php
        $sql2 = "SELECT * FROM shop where category = 'album';";  
        ...
        if($resultCheck2 > 0){
          ...
          //albums start
            ...
            echo "<a href=\"albums.php?id=".$row2['id']."\">";
